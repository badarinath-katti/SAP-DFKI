...
namespace GSFCCache
{
    ...
    public class GSFCCache : ApplicationMethodsBase
    {
        ...
        private object AssignNextOperation(Tuple<XElement, String, String> RoutingStepElement_Product)
        {
            string ShopOrder = RoutingStepElement_Product.Item1.Attribute("ShopOrder").Value;
            int RoutingStepID = Convert.ToInt32(RoutingStepElement_Product.Item1.Attribute("ID").Value);
            try
            {
                if (RoutingStepElement_Product.Item1.Attribute("Status").Value.Equals(OperationState.Done.ToString("G")))
                {
                    ...
                    try
                    {
                        ...
                        DelegateWork(new Tuple<XElement, string, string>(NextRoutingStep, RoutingStepElement_Product.Item2, null));
                    }
        ...
        private Boolean StartSFC()
        {
            ...
            ThreadedExecuter<Tuple<XElement, String, String>, Tuple<XElement, String, String>> threadedExecuter =
                new ThreadedExecuter<Tuple<XElement, String, String>, Tuple<XElement, String, String>>(DelegateWork, null);
            threadedExecuter.Start(new Tuple<XElement, String, String>(RoutingStep, shopOrder.Value.Product, null));
