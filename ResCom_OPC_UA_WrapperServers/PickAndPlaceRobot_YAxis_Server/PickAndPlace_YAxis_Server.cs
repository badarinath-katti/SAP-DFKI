...
namespace PickAndPlaceRobot_YAxis_Server
{
    public class PickAndPlace_YAxis_Server : ApplicationMethodsBase
    {
        private static Guid empTestNodeId = new Guid("e1a22dd8-99a3-48bc-bfd9-23c536f96406");
        private static Guid GetCoOrdinatesMethodId = new Guid("8fffb951-ff80-4cb5-ad03-0f9dcc62c906");
        private static Guid HomeMethodId = new Guid("ab33a2cd-8c52-4eab-8ad0-75ea302c5d95");
        private static Guid JogMoveMethodId = new Guid("a2ea53dc-e0d0-4249-8b67-3d01db4fe4b6");
        private static Guid JogMoveStopMethodId = new Guid("e2210087-c4b9-4d99-9beb-e5e9f3e2a027");
        private static Guid MoveAbsoluteMethodId = new Guid("780bfc57-432d-450c-af2a-870453829c0e");
        private static Guid ReadActualPositionMethodId = new Guid("16ad1bfb-e3d1-4cae-84ea-9eb77429829f");
        private static Guid StopMethodId = new Guid("e16f2d1c-88f7-4703-bd9a-f262676e4d7a");

        public PickAndPlace_YAxis_Server()
        {
        ...
        private EmpMetaData createEMPExampleMetaData()
        {
            ...
            GetCoOrdinatesMetaData.Description = "Gets Current Y CoOrdinate from the Robot";
            ...
            HomeMetaData.Description = "The robot moves to home in Y - direction";
            ...
            MoveAbsoluteMetaData.Description = "The robot moves to a instructed Y Co-Ordinate";
            ...
            MoveAbsoluteMetaData.InputParameters.Add("position", new Tuple<string, Type>("y-Position", Type.GetType("System.Int32")));
        ...
        {
            String SoapResult = Executor.Execute(Executor.yMoveToHomePath, Executor.translateElectricLinmot_WSDL, Executor.moveAbsoluteRequest);
            Dictionary<string, object> result = new Dictionary<string, object>();
            return new Tuple<Dictionary<string, object>, object>(result, null);
        }
        ...
        {
            String SoapResult = Executor.Execute(Executor.yMoveToHomePath, Executor.translateElectricLinmot_WSDL, 
                Executor.moveAbsoluteRequest, position.ToString());
